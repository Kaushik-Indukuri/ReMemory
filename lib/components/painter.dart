...
class BackgroundPainter extends CustomPainter{
  ...
  BackgroundPainter() :
        bluePaint = Paint()..color = background1..style = PaintingStyle.fill,
        greyPaint = Paint()..color = background1..style = PaintingStyle.fill,
        greenPaint = Paint()..color = green2..style = PaintingStyle.fill;
  ...
  void paintGrey(Canvas canvas, Size size) {
    ...
    path.lineTo(0, 0);
    _addPointsToPath(path, [
      Point(size.width*0, size.height*0.35),
      Point(size.width*0, size.height*0.35),
      Point(size.width*0.25, size.height*0.6),
      Point(size.width*0.55, size.height*0.5),
      Point(size.width*0.9, size.height*0.275),
