...
class _EditContactState extends State<EditContact> {
  ...
  getUserInfo() async{
    ...
    setState(() {});
    firstname = TextEditingController(text: "Bill");
    lastname = TextEditingController(text: "Gates");
    relation = TextEditingController(text: "Mentor");
    memories = TextEditingController(text: "Microsoft");
  }
                    ...
                    child: Align(
                      ...
                      child: Container(
                        ...
                        child: _image!=null ? Image.file(_image, fit: BoxFit.cover,)
                            : Image(
                          image: NetworkImage('http://www.gstatic.com/tv/thumb/persons/614/614_v9_bc.jpg'),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
